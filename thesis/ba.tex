...
Add resources!
\begin{itemize}
\item (Classification of Concrete Textual Syntax Mapping
\end{itemize}
...
\section{Finding of the subject}
\label{sec-1-4}
...
other than basic arithmetic. Therefore, a possibility to \emph{extend}
