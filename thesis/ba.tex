...
palette \footnote{Defaults to the shortcut \keys{\ctrl+\shift+P}.}, where available \mypddl commands are displayed and
...
The annual workshop Knowledge Engineering for Planning and Scheduling
(KEPS) promotes the current research in planning and scheduling
technology. Potentially, the main focus of implementing models in
