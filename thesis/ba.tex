...
requirements include \verb~:strips~ For a list of current requirement flags
and their meaning, see \ldots{} It should be mentioned, that almost no
...
\begin{minted}[frame=lines,fontsize=\scriptsize,linenos]{clojure}
(ns org-ba.core
  (:gen-class :main true)
   ...
   (let [input-domain (first args)
     ...
     (exit-on-close
      (quil/sketch
       ...
       :size (vec img-size))))))
\end{minted}
\begin{minted}[frame=lines,fontsize=\scriptsize,linenos]{YAML}
