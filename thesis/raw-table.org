...
# Very, very good
#+NAME: ttot-without-q4-plot
#+BEGIN_SRC R :var ttot=ttot-gmean points=ttot :results output graphics :file ttot.png :exports value
 library(ggplot2)

ggplot(data=ttot, aes(x=Tool,y=TotalTime)) +

geom_bar(stat="identity",width=.3) + 
geom_point(data = points, size = 1, colour = 'black',
               stat = "identity") + 
  scale_fill_hue(name="Total Time on Task") +  # Legend label, use darker colors
      ggtitle("Average Total Time on Task (Arithmetic Mean)\nfor myPDDL (with Data Values)") +  
...
#+RESULTS: ttot-without-q4-plot
[[file:ttot.png]]

# Very, very good
#+NAME: new-plot-without-q4
#+BEGIN_SRC R :var ttot=ttot-gmean points=ttot :results output graphics :file ttot1.png :exports value
  library(ggplot2)
    
    ggplot(ttot, aes(x=Tool, y=TotalTime,fill=Tool)) +
    geom_bar(position=position_dodge(), stat="identity") +
    geom_point(data = points, aes(x=Tool, y = TotalTime, fill=Tool), size = 1, colour = 'black',
